...
{
    internal class CuratorPermissionManager : PermissionManager
    {
        private readonly User user; 
        public CuratorPermissionManager(User user) => this.user = user;
        ...
        public override List<Filter> GetContractsReadFilters => new List<Filter>() { new Filter("LocalitiesList", user.Workplace.FullName)};
